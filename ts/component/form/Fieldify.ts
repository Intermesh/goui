import {Observable, ObservableListenerOpts} from "../Observable.js";
import {Component, ComponentConstructor, ComponentEventMap} from "../Component.js";
import {FieldEventMap} from "./Field.js";


export interface FieldifyConfig<T extends Observable> {
	/**
 ...
 * @inheritDoc
 */
export interface FieldifyEventMap<T extends Observable> extends ComponentEventMap<T> {
	/**
...
/**
 * Fieldify mixin to make form fields
 *
 * @param Base
 * @constructor
 */
export function Fieldify<T extends ComponentConstructor<Component>>(Base: T)  {

	interface Fieldified {
		on<K extends keyof FieldifyEventMap<Component>>(eventName: K, listener: FieldEventMap<Component>[K], options?: ObservableListenerOpts): void;
		fire<K extends keyof FieldifyEventMap<Component>>(eventName: K, ...args: Parameters<NonNullable<FieldEventMap<Component>[K]>>): boolean
	}

	class Fieldified extends Base {
