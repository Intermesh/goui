import {Component, ComponentConstructor, ComponentEventMap} from "./Component.js";
import {Observable, ObservableConfig, ObservableListenerOpts} from "./Observable.js";
 ...
 * @inheritDoc
 */
export interface DraggableEventMap<T extends Observable> extends ComponentEventMap<T> {
	/**
...
export interface DraggableConfig<T extends Observable> extends ObservableConfig<T> {
	/**
...
/**
 * Draggable mixin to make components draggable
 *
 */
export function Draggable<T extends ComponentConstructor<Component>>(Base: T) {

	interface DraggableCls extends Component {
		on<K extends keyof DraggableEventMap<Component>>(eventName: K, listener: (DraggableEventMap<Component>)[K], options?: ObservableListenerOpts): void
		fire<K extends keyof DraggableEventMap<Component>>(eventName: K, ...args: Parameters<NonNullable<(DraggableEventMap<Component>)[K]>>): boolean
	}

	class DraggableCls extends Base {
